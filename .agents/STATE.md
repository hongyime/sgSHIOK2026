...
Status:
- P352 is complete pending commit: browser-smoke scored-state JSON now exposes `shelter_map_has_locked_score` while preserving `score_has_max_denominator` as a compatibility alias; focused deployment test and repo integrity passed.
