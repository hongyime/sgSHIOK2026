...
Machine: `Prawn-E14`
Latest substantive commit: `c12bdb2` (`fix: retire import-time diagnostic readers`)
...
- Evidence: `qa/verification/P767-rescope-retired.md`, `qa/verification/P768-freshness-copy-density.md`, and `qa/verification/P769-import-time-diag-retirement.md`.
