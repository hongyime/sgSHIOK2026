...
Machine: `Prawn-E14`
Remote main at P79 start: `0c98060`
...
- P79 is in progress: the transit target tabs now label route evidence availability before the user switches modes.
...
- P79 evidence is being recorded at `qa/verification/P79-transit-target-availability.md`.
