...
Machine: `Prawn-E14`
Remote main after P202: pending
...
Status:
- P202 is in progress: the title-card data freshness line now names the oldest current source, NParks Leaf Area Index at 112.5 days old, instead of only reporting current/stale/manual counts; focused web copy test passes.
