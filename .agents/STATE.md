...
Machine: `Prawn-E14`
Remote main at P80 start: `58e526c`
...
- P80 is in progress: the night-lighting layer note now tells users to switch on and zoom into a neighbourhood to load lamp points.
...
- P80 evidence is being recorded at `qa/verification/P80-night-lighting-zoom-disclosure.md`.
