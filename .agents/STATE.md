...
Machine: `Prawn-E14`
Latest substantive commit: `e3b2ccb` (`feat: add night lighting detail action`)
...
- Checks: `uv run pytest tests/test_legacy_geocode.py -q` passed 2/2; `uv run pytest tests/test_legacy_diag_scripts.py -q` passed 1/1; `uv run pytest tests/test_legacy_script_diagnostics.py -q` passed 1/1; `uv run pytest tests/test_analysis_scripts.py -q` passed 25/25 after P785; `uv run pytest tests/test_audit_560234_shelter.py -q` passed 3/3; `uv run pytest tests/test_mayflower_qa_summary.py -q` passed 8/8 after P782; `uv run pytest tests/test_heat_presentation_analysis.py -q` passed 6/6 after P784; `uv run pytest tests/test_mayflower_qa_summary.py tests/test_heat_presentation_analysis.py -q` passed 14/14 after P785; `uv run pytest tests/test_analysis_scripts.py tests/test_mayflower_qa_summary.py tests/test_heat_presentation_analysis.py -q` passed 39/39 after P786; `npm --prefix web test -- subscore-ranking.test.ts accessibility-render.test.tsx score-card-copy.test.ts` passed 59/59; `npm --prefix web test -- accessibility-render.test.tsx score-card-copy.test.ts` passed 55/55; `npm --prefix web test -- score-card-copy.test.ts accessibility-render.test.tsx` passed 55/55 for P778, P779, P783, and P787; `npm --prefix web test -- data.test.ts` passed 5/5 after the P781 timeout fix; `npm --prefix web test` passed 166/166 after P787; `uv run pytest -q --collect-only` collected 624 after P787; repo integrity passed; protected-diff guard passed.
