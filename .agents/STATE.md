...
Machine: `Prawn-E14`
Remote main at P78 start: `ead74ea`
...
- P78 is in progress: the title-card score coverage line now uses route-evidence language for partial, beyond-range, and awaiting-scoring records.
...
- P78 evidence is being recorded at `qa/verification/P78-score-coverage-wording.md`.
