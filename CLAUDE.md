...
OneMap-derived postal scrape. The P19 v2 28 Aug 2026 public-source sample found 6
...
unvalidated MCST proxy warnings. The same P19 v2 run's Overpass coverage
cross-check found 25,919 valid distinct OSM `addr:postcode` values, of which
25,899 overlap frozen v1 and 20 are valid OSM-only postcodes. Treat OSM as geometry
