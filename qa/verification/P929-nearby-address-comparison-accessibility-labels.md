# P929 Nearby-Address Comparison Accessibility Labels

## Scope

Free-tier browser accessibility copy/test/evidence work only.
...
npm notice run node scripts/test-web.mjs score-card-copy.test.ts accessibility-render.test.tsx
 ...
 Test Files  2 passed (2)
      Tests  63 passed (63)
   Start at  17:04:26
   Duration  4.59s (transform 1.49s, setup 0ms, import 1.94s, tests 1.22s, environment 1ms)
```
...
1. The comparison panel's visible title used `Compare nearby addresses`, but its ARIA/select labels still said `Planning-area comparison`, so assistive technology got a different name for the same surface.
