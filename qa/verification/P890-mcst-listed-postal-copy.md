...
Postal-specific MCST address-quality caveats now say `listed postal` instead of `recorded postal`.
...
npm notice run node scripts/test-web.mjs score-card-copy.test.ts accessibility-render.test.tsx
 ...
 Test Files  2 passed (2)
      Tests  63 passed (63)
   Start at  14:18:16
   Duration  2.28s (transform 726ms, setup 0ms, import 951ms, tests 567ms, environment 0ms)
```
...
1. The MCST address-quality caveat still used `recorded postal`, which reads like internal data-entry language in an end-user explanation.
