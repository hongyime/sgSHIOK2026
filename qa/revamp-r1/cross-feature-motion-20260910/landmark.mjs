...
// Owner-approved public-landmark use; no home-postal recommendation or data generation.
const postal='049213';
...
if(typeof shard==='string')report.geometry=read(shard.startsWith('geom/')?shard:'geom/'+shard).find(r=>r.postal===postal);
writeFileSync(resolve(root,'qa/revamp-r1/cross-feature-motion-20260910/landmark.json'),JSON.stringify(report,null,2)+'\n',{flag:'wx'});
