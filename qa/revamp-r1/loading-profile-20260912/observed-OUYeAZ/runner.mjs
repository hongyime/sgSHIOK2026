...
const out = mkdtempSync(resolve(root, 'qa/revamp-r1/loading-profile-20260912/observed-'));
...
try {
  ...
  sampler = spawn('typeperf.exe', ['\\\\Memory\\\\Available MBytes', '\\\\Memory\\\\Pages Input/sec', '\\\\Memory\\\\Pages Output/sec', '\\\\Processor(_Total)\\\\% Processor Time', '-si', '1', '-sc', '300'], { cwd: root, windowsHide: true, stdio: ['ignore','pipe','pipe'] });
