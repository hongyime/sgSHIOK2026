...
replace("'http://127.0.0.1:4412'","'http://127.0.0.1:4418'");
replace("'qa/revamp-r1/completion-20260913/build-2/build.json'","'qa/revamp-r1/selection-recovery-20260913/build-1/build.json'");
