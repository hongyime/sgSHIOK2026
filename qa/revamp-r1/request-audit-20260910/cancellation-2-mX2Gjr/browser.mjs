...
try {
  ...
  const after = await evaluate(facts); check('same selected route survives cancellation probe', after.routeKey === original.routeKey && after.featureCount === original.featureCount, { original, after });
  let stable = 0;
