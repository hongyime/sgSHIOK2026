...
const identity={root,pid:process.pid,origin:'http://127.0.0.1:4344',buildA,buildB:b.buildId,workerHashes,target,targetBytes:targetBytes.length,targetSha256:sha(targetBytes),sourceB:b.snapshot};
...
server.listen(4344,'127.0.0.1',()=>{writeFileSync(receipt,JSON.stringify(identity,null,2)+'\n',{flag:'wx'});console.log(JSON.stringify(identity));});
