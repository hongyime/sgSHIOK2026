"""One owned production-candidate browser run; credentials remain in runtime memory."""
import hashlib
import json
import os
...
_write_new(BASE / "production-acceptance-execution.json", (json.dumps(result, indent=2)+"\n").encode())
