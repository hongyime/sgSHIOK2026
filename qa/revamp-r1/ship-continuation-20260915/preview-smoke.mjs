...
const buttonSubmit=process.argv[3]==='--button-submit';
assert.deepEqual(process.argv.slice(2),buttonSubmit?['--go','--button-submit']:['--go']);
...
const out=resolve(BASE,buttonSubmit?'browser-02':'browser-01');
...
const report={origin,deployment:'dpl_DiLpW8ZRPGSiaQHM76JZsocKC7pJ',startedAt:new Date().toISOString(),
  checks:[],responses:[],errors:[],captures:[],blockedMutations:[],droppedResponses:0,passed:false,submitControl:buttonSubmit?'native button click':'CDP keyDown/keyUp only',
