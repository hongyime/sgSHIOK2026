...
const origin = 'http://127.0.0.1:4404', hash = bytes => createHash('sha256').update(bytes).digest('hex');
...
try {
  ...
  const build = JSON.parse(readFileSync(resolve(root, 'qa/revamp-r1/walk-only-20260913/build-1/build.json')));
