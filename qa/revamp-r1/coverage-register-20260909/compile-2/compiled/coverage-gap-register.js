...
function coverageGapRow(input) {
    ...
    const categories = input.geometryLookup === 'not_read' ? [] : ['bus', 'mrt_lrt'].map(category => {
    ...
    return {
        ...
        rangeLimit: reason === 'all_routed_transit_candidates_beyond_access_range'
            ...
            : state === 'NO_TRANSIT_IN_RANGE' ? 'eligibility_state_distance_cause_not_established' : 'not_established',
