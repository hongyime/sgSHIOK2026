import { handleModerationPost, moderationMethodNotAllowed } from '../http';

export const runtime = 'nodejs';
export const dynamic = 'force-dynamic';
export const maxDuration = 20;

export async function POST(request: Request): Promise<Response> { return handleModerationPost(request, 'decision'); }
