...
for(const [before,after] of [
  ['qa/revamp-r1/completion-20260913/build-1','qa/revamp-r1/keyboard-recovery-20260913/build-1'],
  ['tmp/completion-20260913-build-1','tmp/keyboard-recovery-20260913-build-1']]){
  assert.equal(code.split(before).length,2);code=code.replace(before,after);
}
const runner=resolve(root,'qa/revamp-r1/keyboard-recovery-20260913',`build-${Date.now()}.mjs`);
