...
function scoreStateNote(score: ScoreRecord, transitMode: TransitAccessMode): string | null {
  ...
  if (score.state === "SCORED_PARTIAL") {
    return "Partial locked score: shelter-map evidence may still be present, but one or more component scores are unavailable; locked weights count missing terms as zero.";
  }
  ...
  return (
    <main className={styles.appShell}>
      ...
      <section className={styles.searchOverlay} aria-label="Address search" aria-busy={loading}>
        ...
        <footer className={styles.pageFooter}>Source-derived covered-walkway, exposure-gap, and night-lighting map evidence.</footer>
      </section>
    </main>
  );
}
